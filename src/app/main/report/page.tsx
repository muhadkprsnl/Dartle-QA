...
export default function NewReportPage() {
    ...
    // // For dev form
    // const { calculateTotalBugs } = setupBugCalculation(devForm, devFieldMap);

    // // For prod form
    // const { calculateTotalBugs: calculateProdBugs } = setupBugCalculation(prodForm, prodFieldMap);
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex flex-row items-center space-x-2 mt-4">
                                                ...
                                                {/* <FormLabel style={margin - top:0rem !important}>Feature</FormLabel> */}
                                                <FormLabel style={{ marginTop: '0rem !important' }}>Feature</FormLabel>
                                            </FormItem>
                                        )}
                                    />
                                </div>
